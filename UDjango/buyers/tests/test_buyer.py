...
class BuyerModelTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.address = Address.objects.create(street='Stroiteley', house_number='21')
    ...
    def test_buyer_string_representation(self):
        ...
        buyer = Buyer(first_name='Брюс', last_name='Ли', phone_number='+79991234567')
        self.assertEqual(str(buyer), 'Брюс Ли - +79991234567')
    ...
    def test_delete_buyer(self):
        ...
        buyer_id = buyer.id  # Сохраняем ID для проверки удаления
        buyer.delete()
        with self.assertRaises(Buyer.DoesNotExist):
            Buyer.objects.get(id=buyer_id)
